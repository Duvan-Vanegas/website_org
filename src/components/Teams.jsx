...
const Teams = () => {
    return (
        ...
        lg:px-24 xl:px-40 pt-30 text-gray-800 dark:text:white'>
            ...
            dedicated to your brand sucsess.'/>
            ...
            <div className='grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-5'>
                { teamData.map((team, index)=>(
                    ...
                    rounded-xl border border-gray-100 dark:border-gray-700 br-white dark:bg-gray-900
                    shadow-xl shadow-gray-100 dark:shadow-white/5 hover:scale-103 transtion-all duration-400'>
